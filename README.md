...
2. 터미널 실행 명령어는 yarn dev 입니다!(Insomnia에서 로컬호스트로 테스트해주세요.😊)
## 프로젝트 소개
...
데이터를 게시, 수정 혹은 삭제하는 API들은 2차, 3차 피해를 야기할 수 있으므로 인증을 필요로 해야 합니다. 악의적인 사용자가 이를 악용할 수 있기 때문입니다. 따라서, 사용자의 신원에 따라 차등적으로 권한을 부여하는 것이 필수적입니다.</br>
